...
<div class="divcarousel">
    ...
    <div class="orsignup">Already member? <a href="<?php echo e(URL::route('login')); ?>">Log in</a></div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\TestLaravel\resources\views/welcome.blade.php ENDPATH**/ ?>