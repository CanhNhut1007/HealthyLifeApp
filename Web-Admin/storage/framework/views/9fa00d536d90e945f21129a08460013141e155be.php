            ...
            <div class="container">
                ...
                <div class="divbutton">
                    <form action="">
                        ...
                        <div class="forgotpassword"><a href="<?php echo e(URL::asset('forgotpassword')); ?>">Forgot Password?</a></div>
                        <div class="Input_Info">
                        ...
                        <div class="orsignup">or <a href="<?php echo e(URL::asset('signup')); ?>">Sign up</a></div>
                    </form>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\TestLaravel\resources\views/Login.blade.php ENDPATH**/ ?>