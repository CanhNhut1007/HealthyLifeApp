...
<div class="text-center content">
    ...
    <div class="Input_Info">
        <div class="textinput">
            ...
            <form method="POST" action="<?php echo e(route('user.verifyresetpassword')); ?>">
...
<?php echo $__env->make('member.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\learncode\TestLaravel\resources\views/member/showverifyresetpassword.blade.php ENDPATH**/ ?>