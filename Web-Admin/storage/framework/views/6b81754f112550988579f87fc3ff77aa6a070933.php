    ...
    <div class="main_content_div">
        <div id="account-version_div" class="div_parent_acc">
            <div class="col-6 column_acc" id="column_name_account"><img id="icon_acc" src="<?php echo e(URL::asset('img/icon-account.png')); ?>" width="64" height="64">
                <div class="div_chi_acc-ver"><small class="form-text text-muted" id="text_name_account">Dr.<?php echo e($employeename); ?></small><a id="text_editprofile" class="edit_profile" href="<?php echo e(route('doctor.profile')); ?>">Edit profile</a></div>
            </div>
        ...
        <div class="div_parent_sslt">
            <div>
                <div class="col column_sslt" src="assets/img/icon-setting.png"><img class="img_sslt" src="<?php echo e(URL::asset('img/icon-setting.png')); ?>" width="40" height="40">
                    <div class="div_text_sslt"><a class="link_sslt" href="<?php echo e(route('doctor.setting')); ?>">Settings</a><small class="form-text text-muted">Configure your account your way</small></div>
                </div>
            </div>
            <div>
                <div class="col column_sslt" src="assets/img/icon-setting.png"><img class="img_sslt" src="<?php echo e(URL::asset('img/icon-help.png')); ?>" width="40" height="40">
                    <div class="div_text_sslt"><a class="link_sslt" href="<?php echo e(route('doctor.support')); ?>">Support</a><small class="form-text text-muted">24/7 customer support</small></div>
                </div>
            </div>
            <div>
                <div class="col column_sslt" src="assets/img/icon-setting.png"><img class="img_sslt" src="<?php echo e(URL::asset('img/icon-logout.png')); ?>" width="40" height="40">
                    <div class="div_text_sslt"><a class="link_sslt" href="<?php echo e(route('doctor.logout')); ?>">Log out</a><small class="form-text text-muted">Securely log out of the site</small></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('doctor.main.layouts.layout_doctor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\learncode\TestLaravel\resources\views/doctor/main/account.blade.php ENDPATH**/ ?>