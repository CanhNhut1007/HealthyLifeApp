            ...
            <div class="header">
                <div class="bar">
                    <div class="contentBar">
                        <div class="logo">
                            <img src="<?php echo e(URL::asset('image/health_life.png')); ?>" alt="logo">
                        </div>
                        <div class="options">
                            <nav>
                                <ul>
                                    ...
                                    <li class="subnav">
                                        <div class="div-subnav">
                                            ...
                                            <div class="subnav-content">
                                                <ul>
                                                    <li>
                                                        <a id="a-bar" role="button" tabindex="0" href="Signup.html">For Patient</a>
                                                    </li>
                                                </ul>    
                                            </div>
                                        </div>
                                        <div class="div-subnav">
                                            ...
                                            <div class="subnav-content">
                                                <ul>
                                                    <li>
                                                        <a id="a-bar" role="button" tabindex="0" href="Login.html">For Patient</a>
                                                    </li>
                                                    <li>
