...
import com.example.sdkfacebook.mainactivity.SettingAccount;

public class doctor_accout extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        row=inflater.inflate(R.layout.activity_doctor_accout, null);//container, false);
